...
class Blog_Designer_Lite_Template {
	...
	public static function bd_column_class( $settings ) {
		$column_class = '';
		$total_col = ( isset( $settings['template_columns'] ) && '' != $settings['template_columns'] ) ? $settings['template_columns'] : 2; //phpcs:ignore
		...
		$total_col_ipad = ( isset( $settings['template_columns_ipad'] ) && '' != $settings['template_columns_ipad'] ) ? $settings['template_columns_ipad'] : 1; //phpcs:ignore
		...
		$total_col_tablet = ( isset( $settings['template_columns_tablet'] ) && '' != $settings['template_columns_tablet'] ) ? $settings['template_columns_tablet'] : 1; //phpcs:ignore
		...
		$total_col_mobile = ( isset( $settings['template_columns_mobile'] ) && '' != $settings['template_columns_mobile'] ) ? $settings['template_columns_mobile'] : 1; //phpcs:ignore
	...
	public static function bd_classical_template( $alterclass ) {
		...
		<div class="blog_template bdp_blog_template classical">
			...
			<div class="bd-blog-header">
				...
				if ( 0 == $display_date || 0 == $display_author || 0 == $display_comment_count ) { //phpcs:ignore
					?>
					<div class="bd-metadatabox"><div class="bd-meta-datas" style="display:inline-block;">
							<?php
							if ( 0 == $display_author && 0 == $display_date ) { //phpcs:ignore
				...
				if ( 0 == get_option( 'display_category' ) ) { //phpcs:ignore
					?>
				...
				if ( 0 == get_option( 'display_tag' ) ) { //phpcs:ignore
			...
			<div class="bd-post-content">
				<?php echo Blog_Designer_Lite_Public::bd_get_content( get_the_ID() ); //phpcs:ignore ?>
				<?php
				if ( 1 == get_option( 'rss_use_excerpt' ) && 1 == get_option( 'read_more_on' ) ) { //phpcs:ignore
					$read_more_class = ( 1 == get_option( 'read_more_on' ) ) ? 'bd-more-tag-inline' : 'bd-more-tag'; //phpcs:ignore
					if ( '' != get_option( 'read_more_text' ) ) { //phpcs:ignore
			...
			<div class="bd-post-footer">
				<?php if ( 0 != get_option( 'social_share' ) && ( ( 0 == get_option( 'facebook_link' ) ) || ( 0 == get_option( 'twitter_link' ) ) || ( 0 == get_option( 'linkedin_link' ) ) || ( 0 == get_option( 'pinterest_link' ) ) ) ) { //phpcs:ignore ?>
					<div class="social-component">
						<?php if ( 0 == get_option( 'facebook_link' ) ) : //phpcs:ignore ?>
						...
						<?php endif; ?>
						<?php if ( 0 == get_option( 'twitter_link' ) ) : //phpcs:ignore ?>
						...
						<?php endif; ?>
						<?php if ( 0 == get_option( 'linkedin_link' ) ) : //phpcs:ignore ?>
						...
						<?php
						$pinterestimage = '';
						if ( 0 == get_option( 'pinterest_link' ) ) : //phpcs:ignore
				...
				<?php } ?>
				<?php
				if ( 1 == get_option( 'rss_use_excerpt' ) && 2 == get_option( 'read_more_on' ) ) { //phpcs:ignore
					if ( '' != get_option( 'read_more_text' ) ) { //phpcs:ignore
	...
	public static function bd_crayon_slider_template() {
		...
		<li class="blog_template bdp_blog_template crayon_slider">
			...
			<div class="blog_header">
				<?php
				if ( 0 == $display_category ) { //phpcs:ignore
					?>
				...
				<h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
				<?php
				if ( 0 == $display_author || 0 == $display_date || 0 == $display_comment_count ) { //phpcs:ignore
					?>
					<div class="metadatabox">
						...
						if ( 0 == $display_author || 0 == $display_date ) { //phpcs:ignore
							...
							if ( 0 == $display_date ) { //phpcs:ignore
								$date_format = get_option( 'date_format' );
								?>
								<div class="post-date">
				...
				<div class="post_content">
					<div class="post_content-inner">
						<?php echo Blog_Designer_Lite_Public::bd_get_content( get_the_ID() ); //phpcs:ignore ?>
						<?php
						if ( 1 == get_option( 'rss_use_excerpt' ) && 0 != get_option( 'read_more_on' ) ) { //phpcs:ignore
						$class = 'bd-more-tag-inline';
						if ( 2 == get_option( 'read_more_on' ) ) { //phpcs:ignore
							$class = 'bd-more-tag';
	...
	public static function bd_boxy_clean_template( $settings ) {
		...
		?>
		<li class="blog_wrap bdp_blog_template <?php echo ( '' != $col_class ) ? esc_attr( $col_class ) : ''; //phpcs:ignore ?> bdp_blog_single_post_wrapp">
			<?php
			$display_date          = get_option( 'display_date' );
			$display_author        = get_option( 'display_author' );
			$display_category      = get_option( 'display_category' );
	...
	public static function bd_lightbreeze_template( $alterclass ) {
		...
		<div class="blog_template bdp_blog_template box-template active lightbreeze <?php echo esc_attr( $alterclass ); ?>">
			...
			<div class="bd-blog-header">
				...
				$display_category      = get_option( 'display_category' );
				$display_comment_count = get_option( 'display_comment_count' );
				if ( 0 == $display_date || 0 == $display_author || 0 == $display_category || 0 == $display_comment_count ) { //phpcs:ignore
					?>
	...
	public static function bd_spektrum_template() {
		...
		<?php if ( has_post_thumbnail() ) { ?>
			...
			<div class="spektrum_content_div">
				<div class="bd-blog-header
				<?php
				if ( 0 != get_option( 'display_date' ) ) { //phpcs:ignore
					echo ' disable_date';
				}
				?>
				">
				<?php if ( 0 == get_option( 'display_date' ) ) { //phpcs:ignore ?>
				...
				<div class="bd-post-content">
					<?php
					echo Blog_Designer_Lite_Public::bd_get_content( get_the_ID() ); //phpcs:ignore
					if ( 1 == get_option( 'rss_use_excerpt' ) && get_option( 'excerpt_length' ) > 0 ) { //phpcs:ignore
						if ( 1 == get_option( 'read_more_on' ) ) { //phpcs:ignore
							if ( '' != get_option( 'read_more_text' ) ) { //phpcs:ignore
								echo '<a class="bd-more-tag-inline" href="' . esc_url( get_the_permalink() ) . '">' . esc_attr( get_option( 'read_more_text' ) ) . ' </a>';
							} else {
				...
				$display_comment_count = get_option( 'display_comment_count' );
				if ( 0 == $display_category || 0 == $display_author || 0 == $display_tag || 0 == $display_comment_count ) { //phpcs:ignore
					?>
					<div class="post-bottom">
							<?php if ( 0 == $display_category ) { //phpcs:ignore ?>
					...
					<div class="social-component spektrum-social">
						...
						if ( 0 == get_option( 'twitter_link' ) ) : //phpcs:ignore
							?>
						...
						if ( 0 == get_option( 'linkedin_link' ) ) : //phpcs:ignore
							?>
	...
	public static function bd_evolution_template( $alterclass ) {
		...
		<div class="blog_template bdp_blog_template evolution <?php echo esc_attr( $alterclass ); ?>">
			<?php if ( 0 == get_option( 'display_category' ) ) { //phpcs:ignore ?>
		...
		<?php if ( has_post_thumbnail() ) { ?>
			...
			<div class="bd-post-footer">
				<?php if ( 0 != get_option( 'social_share' ) && ( ( 0 == get_option( 'facebook_link' ) ) || ( 0 == get_option( 'twitter_link' ) ) || ( 0 == get_option( 'linkedin_link' ) ) || ( 0 == get_option( 'pinterest_link' ) ) ) ) { //phpcs:ignore ?>
					<div class="social-component">
						<?php
						if ( 0 == get_option( 'facebook_link' ) ) : //phpcs:ignore
							?>
							<a data-share="facebook" data-href="https://www.facebook.com/sharer/sharer.php" data-url="<?php the_permalink(); ?>" class="bd-facebook-share bd-social-share"><i class="fab fa-facebook-f"></i></a>
						<?php endif; ?>
						<?php if ( 0 == get_option( 'twitter_link' ) ) : //phpcs:ignore ?>
			...
			<div class="post_hentry"><p><i class="fas" data-fa-pseudo-element=":before"></i></p><div class="post_content_wrap">
					<div class="post_wrapper box-blog">
						...
						<div class="desc">
							...
							$display_comment_count = get_option( 'display_comment_count' );
							$display_date          = get_option( 'display_date' );
							if ( 0 == $display_date || 0 == $display_comment_count || 0 == $display_date ) { //phpcs:ignore
								?>
								<div class="date_wrap">
									<?php if ( 0 == $display_author ) { //phpcs:ignore ?>
							...
							<?php if ( 1 == get_option( 'rss_use_excerpt' ) && 0 != get_option( 'read_more_on' ) ) : //phpcs:ignore ?>
								<div class="read_more">
									<?php
									global $post;
									if ( 2 == get_option( 'read_more_on' ) ) { //phpcs:ignore
					...
					<?php if ( 0 == get_option( 'display_category' ) || ( 0 != get_option( 'social_share' ) && ( 0 == get_option( 'display_tag' ) || ( 0 == get_option( 'facebook_link' ) ) || ( 0 == get_option( 'twitter_link' ) ) || ( 0 == get_option( 'linkedin_link' ) ) || ( 0 == get_option( 'pinterest_link' ) ) ) ) ) { //phpcs:ignore ?>
						<footer class="blog_footer text-capitalize">
							...
							if ( 0 != get_option( 'social_share' ) && ( ( 0 == get_option( 'facebook_link' ) ) || ( 0 == get_option( 'twitter_link' ) ) || ( 0 == get_option( 'linkedin_link' ) ) || ( 0 == get_option( 'pinterest_link' ) ) ) ) { //phpcs:ignore
								?>
								<div class="social-component">
									<?php if ( 0 == get_option( 'facebook_link' ) ) : //phpcs:ignore ?>
										<a data-share="facebook" data-href="https://www.facebook.com/sharer/sharer.php" data-url="<?php the_permalink(); ?>" class="bd-facebook-share bd-social-share"><i class="fab fa-facebook-f"></i></a>
	...
	public static function bd_glossary_template( $settings ) {
		...
		$display_comment_count = get_option( 'display_comment_count' );
		?>
		<div class="glossary bdp_blog_template blog_template blog_masonry_item <?php echo ( '' != $col_class ) ? esc_attr( $col_class ) : ''; //phpcs:ignore ?>">
			<div class="blog_item">
				<div class="blog_header">
					<?php
					if ( 0 == $display_date ) { //phpcs:ignore
					...
					if ( 0 == $display_comment_count ) { //phpcs:ignore
						if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) : //phpcs:ignore
							?>
							<span class="comment"><?php echo ( ( 0 == $display_author && 0 == $display_date ) || ( 0 == $display_author || 0 == $display_date ) ) ? '&nbsp; | &nbsp;' : ''; ?><i class="fas fa-comment"></i><?php comments_popup_link( '0', '1', '%' ); //phpcs:ignore ?></span>
							<?php
						endif;
					}
					?>
				...
				if ( get_the_content() || has_post_thumbnail() ) {
					...
					<div class="post_summary_outer">
						...
						if ( get_the_content() ) {
							...
							<div class="post_content"> 
								<div class="post_content-inner">
									<p><?php echo Blog_Designer_Lite_Public::bd_get_content( get_the_ID() ); //phpcs:ignore ?></p>
									<div class="overlay" style="background:<?php echo self::bd_hex2rgba( $settings['template_color'], 0.9 ); //phpcs:ignore ?>;">
										<?php if ( 1 == get_option( 'rss_use_excerpt' ) && 2 == get_option( 'read_more_on' ) ) { //phpcs:ignore ?>
				...
				?>
				<?php if ( 0 == $display_category || 0 == get_option( 'display_tag' ) ) { //phpcs:ignore ?>
				<div class="blog_footer">
					<div class="footer_meta">
						<?php
						if ( 0 == $display_category ) { //phpcs:ignore
		...
		<div class="blog_template bdp_blog_template news <?php echo esc_attr( $alter ); ?>">
			...
			<div class="post-content-div<?php echo esc_attr( $full_width_class ); ?>">
				<div class="bd-blog-header">
					...
					$display_author        = get_option( 'display_author' );
					$display_comment_count = get_option( 'display_comment_count' );
					if ( 0 == $display_author || 0 == $display_comment_count ) { //phpcs:ignore
						?>
				...
				$display_category = get_option( 'display_category' );
				$display_tag      = get_option( 'display_tag' );
				if ( 0 == $display_category || 0 == $display_tag ) { //phpcs:ignore
					?>
