...
if( ! defined('WPOSTAHS_VERSION') ) {
	define( 'WPOSTAHS_VERSION', '1.4.5' ); // Plugin version
}
...
if( ! defined( 'WPOSTAHS_PLUGIN_LINK' ) ) {
	define( 'WPOSTAHS_PLUGIN_LINK', 'https://www.wponlinesupport.com/wp-plugin/timeline-history-slider/?utm_source=WP&utm_medium=WP-Plugins&utm_campaign=Features-PRO#fndtn-lifetime' ); // Plugin post type
}
