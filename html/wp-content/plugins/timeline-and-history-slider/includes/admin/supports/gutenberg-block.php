...
function wpostahs_register_guten_block() {
	...
	// Block Editor Script
	wp_register_script( 'wpostahs-block-js', WPOSTAHS_URL.'assets/js/blocks.build.js', array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'wp-components' ), WPOSTAHS_VERSION, true );
	wp_localize_script( 'wpostahs-block-js', 'WposTahs_Block', array(
																'pro_demo_link' => 'https://demo.wponlinesupport.com/prodemo/timeline-and-history-slider-pro/',
																'free_demo_link' => 'https://demo.wponlinesupport.com/timeline-and-history-slider-demo/',
...
add_filter( 'block_categories', 'wpostahs_add_block_category' );