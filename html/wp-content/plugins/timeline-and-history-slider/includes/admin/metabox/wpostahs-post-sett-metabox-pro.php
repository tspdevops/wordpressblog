...
?>
<div class="pro-notice"><?php echo sprintf( __( 'Upgrade to <a href="%s" target="_blank">Premium Version</a> to get these option.', 'timeline-and-history-slider'), WPOSTAHS_PLUGIN_LINK); ?></div>
	...
	<tbody>
		...
		<tr class="wpostahs-pro-feature">
			...
			<td>
				...
				<span class="description"><?php _e('Enter read more link. You can add external link also. Leave empty to use default post link. ie ', 'timeline-and-history-slider'); ?>http://wponlinesupport.com/</span>
			</td>
		</tr>
